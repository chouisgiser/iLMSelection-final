...
# @time    : 28.07.20 11:03
# @author  : zhouzy
# @file    : role_ranking_evaluation.py
"""
...
def evaluation_iteration(split_time):
    for model_role in ['staff', 'student']:
        ...
        total_num = 0
        total_true_num = 0
        model_dir = '../../results/dataset_split_iteration/role/iter' + str(split_time) + '/models/ranking_' + model_role + '/'
        pred_data_dir = '../../data/processed/dataset_split_iteration/iter' + str(split_time) + '/ranking/5folds_fam_role/fold'
        pred_results_dir = '../../results/dataset_split_iteration/role/iter' + str(split_time) + '/experiments/evaluation/ranking_' + model_role + '/'
