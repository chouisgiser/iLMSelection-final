...
# @time    : 28.07.20 14:46
# @author  : zhouzy
# @file    : fam_role_ranking_evaluation.py
"""
...
def evaluation_iteration(split_time):
    for model_familiarity in ['familiar', 'unfamiliar']:
        for model_role in ['staff', 'student']:
            ...
            total_num = 0
            total_true_num = 0
            model_dir = '../../results/dataset_split_iteration/fam_role/iter' + str(
                split_time) + '/models/ranking_' + model_role + '_' + model_familiarity + '/'
            pred_data_dir = '../../data/processed/dataset_split_iteration/iter' + str(
                split_time) + '/ranking/5folds_fam_role/fold'
            pred_results_dir = '../../results/dataset_split_iteration/fam_role/iter' + str(
                split_time) + '/experiments/evaluation/ranking_' + model_role + '_' + model_familiarity + '/'
...
for split_time in range(1,11):
    # evaluation_iteration_familiarity_models(split_time)
