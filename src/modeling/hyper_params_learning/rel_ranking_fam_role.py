    ...
    for fold_index in range(1, 6):
        for model_familiarity in ['familiar', 'unfamiliar']:
            for model_role in ['staff', 'student']:
                train_file = data_dir + str(fold_index) + '/' + model_familiarity + '_' + model_role + '/rank.train'
                train_query_file = data_dir + str(fold_index) + '/' + model_familiarity + '_' + model_role + '/rank.train.query'

                eval_file = data_dir + str(fold_index) + '/' + model_familiarity + '_' + model_role + '/rank.test'
                eval_query_file = data_dir + str(fold_index) + '/' + model_familiarity + '_' + model_role + '/rank.test.query'
                ...
                params_grid = {'n_estimators': [10, 20, 30],  # , 10, 20,  40
                ...
                hp_params_file = results_dir + 'experiments/hyperparams/lgbrank_' + model_familiarity + '_'+ model_role + '_params.csv'
