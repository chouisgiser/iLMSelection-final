...
def ranking_iteration(split_time):
    data_dir = '../../../data/processed/dataset_split_iteration/iter' + str(
        split_time) + '/ranking/5folds_overall/fold'
    ...
    for fold_index in range(1, 6):
        train_file = data_dir + str(fold_index) + '/rank.train'
        train_query_file = data_dir + str(fold_index) + '/rank.train.query'
        ...
        hp_params_file = results_dir + 'experiments/hyperparams/lgbrank_params.csv'
